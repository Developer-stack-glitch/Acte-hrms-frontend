...
const DashboardStatCard = ({ title, value, subValue, icon: Icon, color, delay }) => {
    return (
        <motion.div
            ...
            className="bg-white rounded-[15px] p-3 sm:p-6 border border-gray-100 shadow-[0_10px_30px_rgba(0,0,0,0.02)] hover:shadow-[0_15px_40px_rgba(0,0,0,0.05)] transition-all group overflow-hidden relative"
        >
            ...
            <div className="flex items-center justify-between relative z-10">
                ...
                <div className={`w-8 h-8 sm:w-11 sm:h-11 rounded-xl ${color.bg} ${color.text} flex items-center justify-center shadow-md shadow-${color.shadow}/10 group-hover:rotate-6 transition-transform shrink-0`}>
    ...
    return (
        <div className="space-y-6 lg:space-y-8">
                ...
                <div className="flex items-center md:justify-end justify-center gap-2 sm:gap-4 w-full md:w-auto overflow-x-auto no-scrollbar pb-1 md:pb-0">
                    ...
                    {userRole !== 'employee' && (
                        <button
                            ...
                            className={`flex items-center gap-2 px-2 sm:px-6 py-2 sm:py-2.5 rounded-full font-bold text-[11px] sm:text-[13px] border transition-all shrink-0 ${Object.keys(filters).length > 0
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 mb-8">
                <div className="bg-white p-4 sm:p-6 rounded-[15px] border border-gray-100 shadow-sm flex items-center justify-between group transition-all hover:bg-amber-50/30">
                    <div className="space-y-1">
                ...
                <div className="bg-white p-4 sm:p-6 rounded-[15px] border border-gray-100 shadow-sm flex items-center justify-between group transition-all hover:bg-fuchsia-50/30">
                    <div className="space-y-1">
                ...
                <div className="bg-white p-4 sm:p-6 rounded-[15px] border border-gray-100 shadow-sm flex items-center justify-between group transition-all hover:bg-violet-50/30">
                    <div className="space-y-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <motion.div
                    ...
                    className="bg-white md:p-5 p-3 rounded-[15px] border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.03)]"
                >
            ...
            {userRole !== 'employee' && (
                ...
                <>
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="bg-white rounded-[15px] border border-gray-100 shadow-sm overflow-hidden flex flex-col md:h-[470px] h-auto mb-6"
                    >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="bg-white rounded-[15px] border border-gray-100 shadow-sm overflow-hidden flex flex-col h-[350px]"
                        >
                            <div className="md:p-4 p-3 border-b border-gray-50 flex items-center justify-between bg-white sticky top-0 z-10">
                                <div className="flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="bg-white rounded-[15px] border border-gray-100 shadow-sm overflow-hidden flex flex-col h-[400px]"
                        >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        ...
                        <motion.div
                            ...
                            className="bg-white p-5 rounded-[15px] border border-gray-100 shadow-[0_10px_30px_rgba(0,0,0,0.02)]"
                        >
